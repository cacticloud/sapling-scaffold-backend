...
type QueryTokenRequest struct {
	...
	Platform *PLATFORM `protobuf:"varint,2,opt,name=platform,proto3,enum=token.PLATFORM,oneof" json:"platform"`
	// 访问令牌
	// @gotags: json:"access_token"
	...
	UserType *user.TYPE `protobuf:"varint,5,opt,name=user_type,json=userType,proto3,enum=user.TYPE,oneof" json:"user_type"`
	// 用户当前所处域
	// @gotags: json:"domain"
	...
	GrantType *GRANT_TYPE `protobuf:"varint,9,opt,name=grant_type,json=grantType,proto3,enum=token.GRANT_TYPE,oneof" json:"grant_type"`
	// 令牌类型
	// @gotags: json:"type"
	Type *TOKEN_TYPE `protobuf:"varint,10,opt,name=type,proto3,enum=token.TOKEN_TYPE,oneof" json:"type"`
	// 当前空间
	...
	BlockType *BLOCK_TYPE `protobuf:"varint,14,opt,name=block_type,json=blockType,proto3,enum=token.BLOCK_TYPE,oneof" json:"block_type"`
}
...
func (x *QueryTokenRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
type DescribeTokenRequest struct {
	...
	DescribeBy DESCRIBY_BY `protobuf:"varint,1,opt,name=describe_by,json=describeBy,proto3,enum=token.DESCRIBY_BY" json:"describe_by"`
	// 参数值
...
var file_apps_token_pb_rpc_proto_rawDesc = []byte{
	...
	0x72, 0x70, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e,
	0x1a, 0x31, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x61, 0x63,
	0x74, 0x69, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2f, 0x63, 0x61, 0x63, 0x74, 0x69, 0x6b, 0x69, 0x74,
	...
	0x75, 0x65, 0x73, 0x74, 0x12, 0x39, 0x0a, 0x04, 0x70, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x25, 0x2e, 0x63, 0x61, 0x63, 0x74, 0x69, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e,
	0x63, 0x61, 0x63, 0x74, 0x69, 0x6b, 0x69, 0x74, 0x2e, 0x70, 0x61, 0x67, 0x65, 0x2e, 0x50, 0x61,
	0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x04, 0x70, 0x61, 0x67, 0x65, 0x12,
	0x30, 0x0a, 0x08, 0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x0f, 0x2e, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x2e, 0x50, 0x4c, 0x41, 0x54, 0x46, 0x4f,
	...
	0x72, 0x65, 0x73, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x2c, 0x0a, 0x09, 0x75, 0x73, 0x65,
	0x72, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0a, 0x2e, 0x75,
	0x73, 0x65, 0x72, 0x2e, 0x54, 0x59, 0x50, 0x45, 0x48, 0x01, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72,
	0x54, 0x79, 0x70, 0x65, 0x88, 0x01, 0x01, 0x12, 0x16, 0x0a, 0x06, 0x64, 0x6f, 0x6d, 0x61, 0x69,
	...
	0x65, 0x72, 0x49, 0x64, 0x12, 0x35, 0x0a, 0x0a, 0x67, 0x72, 0x61, 0x6e, 0x74, 0x5f, 0x74, 0x79,
	0x70, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x74, 0x6f, 0x6b, 0x65, 0x6e,
	0x2e, 0x47, 0x52, 0x41, 0x4e, 0x54, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x48, 0x02, 0x52, 0x09, 0x67,
	0x72, 0x61, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x88, 0x01, 0x01, 0x12, 0x2a, 0x0a, 0x04, 0x74,
	0x79, 0x70, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x74, 0x6f, 0x6b, 0x65,
	0x6e, 0x2e, 0x54, 0x4f, 0x4b, 0x45, 0x4e, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x48, 0x03, 0x52, 0x04,
	0x74, 0x79, 0x70, 0x65, 0x88, 0x01, 0x01, 0x12, 0x1c, 0x0a, 0x09, 0x6e, 0x61, 0x6d, 0x65, 0x73,
	...
	0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1e, 0x0a, 0x08, 0x69, 0x73, 0x5f, 0x62, 0x6c,
	0x6f, 0x63, 0x6b, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x08, 0x48, 0x04, 0x52, 0x07, 0x69, 0x73, 0x42,
	0x6c, 0x6f, 0x63, 0x6b, 0x88, 0x01, 0x01, 0x12, 0x35, 0x0a, 0x0a, 0x62, 0x6c, 0x6f, 0x63, 0x6b,
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x74, 0x6f,
	...
	0x0a, 0x0b, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x22, 0x72, 0x0a,
	0x14, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x33, 0x0a, 0x0b, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x62,
	0x65, 0x5f, 0x62, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x12, 0x2e, 0x74, 0x6f, 0x6b,
	...
	0x4b, 0x45, 0x4e, 0x10, 0x01, 0x32, 0x43, 0x0a, 0x03, 0x52, 0x50, 0x43, 0x12, 0x3c, 0x0a, 0x0d,
	...
	0x65, 0x6e, 0x2e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x00, 0x42, 0x3b, 0x5a, 0x39, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x61, 0x63, 0x74, 0x69, 0x63, 0x6c,
	0x6f, 0x75, 0x64, 0x2f, 0x73, 0x61, 0x70, 0x6c, 0x69, 0x6e, 0x67, 0x2d, 0x73, 0x63, 0x61, 0x66,
	0x66, 0x6f, 0x6c, 0x64, 0x2d, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2f, 0x61, 0x70, 0x70,
...
var file_apps_token_pb_rpc_proto_goTypes = []interface{}{
	(DESCRIBY_BY)(0),               // 0: token.DESCRIBY_BY
	(*ValidateTokenRequest)(nil),   // 1: token.ValidateTokenRequest
	(*RevolkTokenRequest)(nil),     // 2: token.RevolkTokenRequest
	(*ChangeNamespaceRequest)(nil), // 3: token.ChangeNamespaceRequest
	(*QueryTokenRequest)(nil),      // 4: token.QueryTokenRequest
	(*DescribeTokenRequest)(nil),   // 5: token.DescribeTokenRequest
	(*request.PageRequest)(nil),    // 6: cacticloud.cactikit.page.PageRequest
	(PLATFORM)(0),                  // 7: token.PLATFORM
	(user.TYPE)(0),                 // 8: user.TYPE
	(GRANT_TYPE)(0),                // 9: token.GRANT_TYPE
	(TOKEN_TYPE)(0),                // 10: token.TOKEN_TYPE
	(BLOCK_TYPE)(0),                // 11: token.BLOCK_TYPE
	(*Token)(nil),                  // 12: token.Token
}
var file_apps_token_pb_rpc_proto_depIdxs = []int32{
	6,  // 0: token.QueryTokenRequest.page:type_name -> cacticloud.cactikit.page.PageRequest
	7,  // 1: token.QueryTokenRequest.platform:type_name -> token.PLATFORM
	8,  // 2: token.QueryTokenRequest.user_type:type_name -> user.TYPE
	9,  // 3: token.QueryTokenRequest.grant_type:type_name -> token.GRANT_TYPE
	10, // 4: token.QueryTokenRequest.type:type_name -> token.TOKEN_TYPE
	11, // 5: token.QueryTokenRequest.block_type:type_name -> token.BLOCK_TYPE
	0,  // 6: token.DescribeTokenRequest.describe_by:type_name -> token.DESCRIBY_BY
	1,  // 7: token.RPC.ValidateToken:input_type -> token.ValidateTokenRequest
	12, // 8: token.RPC.ValidateToken:output_type -> token.Token
