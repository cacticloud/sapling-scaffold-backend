...
-- ----------------------------
BEGIN;
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (1, '管理中心', NULL, 1, 0, NULL, NULL, 0, '/mcenter', '管理中心', '', '', 0, 1693820431, 1694339339);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (2, '用户管理', NULL, 1, 0, NULL, NULL, 1, '/mcenter/user', '用户管理', '', '', 1, 1693820431, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (3, '用户列表', NULL, 1, 0, NULL, NULL, 2, '/mcenter/user/list', '用户列表', '', 'sys:user:list', 2, 1693820431, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (4, '新增用户', NULL, 1, 0, NULL, NULL, 3, '/mcenter/user/create', '新增用户', '', 'sys:user:create', 3, 1693820431, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (5, '删除用户', NULL, 1, 0, NULL, NULL, 3, '/mcenter/user/delete', '删除用户', '', 'sys:user:delete', 3, 1693820431, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (6, '更新用户', NULL, 1, 0, NULL, NULL, 3, '/mcenter/user/update', '更新用户', '', 'sys:user:update', 3, 1693820431, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (7, '角色管理', NULL, 1, 0, NULL, NULL, 1, '/mcenter/role', '角色管理', '', '', 1, 1693820431, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (8, '角色列表', NULL, 1, 0, NULL, NULL, 7, '/mcenter/role', '角色列表', '', 'sys:role:list', 2, 1693820431, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (9, '新增角色', NULL, 1, 0, NULL, NULL, 8, '/mcenter/role/create', '新增角色', '', 'sys:role:create', 3, 1693820431, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (10, '删除角色', NULL, 1, 0, NULL, NULL, 8, '/mcenter/role/delete', '删除角色', '', 'sys:role:delete', 3, 1693820431, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (11, '更新角色', NULL, 1, 0, NULL, NULL, 8, '/mcenter/role/update', '更新角色', '', 'sys:role:update', 3, 1693820431, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (12, '权限管理', NULL, 1, 0, NULL, NULL, 1, '/mcenter/permission', '权限管理', '', '', 1, 1693820431, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (13, '权限列表', NULL, 1, 0, NULL, NULL, 12, '/mcenter/permission/list', '权限列表', '', 'sys:permission:list', 2, 1693820431, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (14, '新增权限', NULL, 1, 0, NULL, NULL, 13, '/mcenter/permission/create', '新增权限', '', 'sys:permission:create', 3, 1693820431, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (15, '删除权限', NULL, 1, 0, NULL, NULL, 13, '/mcenter/permission/delete', '删除权限', '', 'sys:permission:delete', 3, 1693820431, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (16, '更新权限', NULL, 1, 0, NULL, NULL, 13, '/mcenter/permission/update', '更新权限', '', 'sys:permission:update', 3, 1693820431, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (17, '服务管理', '', 17, 0, 0, '', 1, '/mcenter/service', '服务管理', '', '', 1, 1694338618, 0);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (18, '服务列表', '', 18, 0, 0, '', 17, '/mcenter/service/list', '服务列表', '', 'sys:service:list', 2, 1694338755, 0);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (19, '新增服务', NULL, 19, 0, NULL, NULL, 18, '/mcenter/service/create', '新增服务', NULL, 'sys:service:create', 3, NULL, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (20, '删除服务', NULL, 20, 0, NULL, NULL, 18, '/mcenter/service/delete', '删除服务', NULL, 'sys:service:delete', 3, NULL, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (21, '更新服务', NULL, 21, 0, NULL, NULL, 18, '/mcenter/service/update', '更新服务', NULL, 'sys:service:update', 3, NULL, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (22, '服务详情', NULL, 22, 0, NULL, NULL, 18, '/mcenter/service/get', '服务详情', NULL, 'sys:service:get', 3, NULL, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (30, '任务中心', NULL, 30, 0, NULL, NULL, 0, '/jobhub', '任务中心', NULL, '', 0, NULL, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (31, '模版管理', NULL, 31, 0, NULL, NULL, 30, '/jobhub/template', '模板管理', NULL, '', 1, NULL, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (32, '模版列表', NULL, 32, 0, NULL, NULL, 31, '/jobhub/template/list', '模版列表', NULL, 'jobhub:template:list', 2, NULL, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (33, '新增模版', NULL, 33, 0, NULL, NULL, 32, '/jobhub/template/create', '新增模版', NULL, 'jobhub:template:create', 3, NULL, NULL);
INSERT INTO `cacticloud`.`mcenter_permission` (`id`, `name`, `icon`, `sort`, `visible`, `service_id`, `resource_name`, `parent_id`, `router_path`, `router_name`, `page_path`, `perms`, `type`, `create_at`, `update_at`) VALUES (34, '删除模版', '', 34, 0, 0, '', 32, '/jobhub/template/delete', '删除模版', '', 'jobhub:template:delete', 3, 1694442043, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `mcenter_role` (`id`, `domain`, `name`, `remark`, `enabled`, `create_at`, `update_at`)
VALUES (1, 'default', 'read-role', '测试创建角色同时添加用户/权限，只读角色', 0, 1694250170, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `mcenter_role_permission` (`id`, `role_id`, `permission_id`)
VALUES (1, 1, 1);
INSERT INTO `mcenter_role_permission` (`id`, `role_id`, `permission_id`)
VALUES (2, 1, 2);
INSERT INTO `mcenter_role_permission` (`id`, `role_id`, `permission_id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `mcenter_service` (`id`, `create_at`, `create_by`, `update_at`, `update_by`, `domain`, `namespace`, `owner`,
                               `enabled`, `name`, `logo`, `remark`, `level`, `client_enabled`, `secret_update_at`,
                               `client_id`, `client_secret`)
VALUES ('11fdd50a', 0, '', 0, '', 'default', 'default', 'admin', 1, 'mcenter', 'https://zcj.cn/service2.jpg',
        'test service interface', 0, 0, 1694250287, 'X4uDSo2rYUM34ZDDlFMZMli9', 'dtwlvXbTFDvINKxqghCgElV5JvPHHDGN');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `mcenter_token` (`id`, `platform`, `access_token`, `refresh_token`, `issue_at`, `access_expired_at`,
                             `refresh_expired_at`, `user_type`, `domain`, `username`, `user_id`, `grant_type`,
                             `token_type`, `namespace`, `scope`, `description`, `is_block`, `block_type`, `block_at`,
                             `block_reason`, `remote_ip`, `city_id`, `country`, `region`, `province`, `city`, `isp`,
                             `os`, `user_agent_platform`, `engine_name`, `engine_version`, `browser_name`,
                             `browser_version`, `meta`)
VALUES (1, 0, 'esNGUd6C9xfCt1DJmCavXQiW', 'txyxabt5ODxKyCaKLf6GUsQKPr3ggynU', 1694251357, 36000, 144000, 15, 'default',
        'root', 1, 0, 0, '', '', '', 0, 1, 1694251783, '你于 2023-09-09T17:29:43+08:00 从其他地方通过 PASSWORD 登录',
        '', 0, '', '', '', '', '', '', '', '', '', '', '', 'null');
INSERT INTO `mcenter_token` (`id`, `platform`, `access_token`, `refresh_token`, `issue_at`, `access_expired_at`,
                             `refresh_expired_at`, `user_type`, `domain`, `username`, `user_id`, `grant_type`,
                             `token_type`, `namespace`, `scope`, `description`, `is_block`, `block_type`, `block_at`,
                             ...
                             `os`, `user_agent_platform`, `engine_name`, `engine_version`, `browser_name`,
                             `browser_version`, `meta`)
VALUES (2, 0, 'yJkcotgqLsqazcThHXXRZMEm', 'QroLsaaihbrhdGodYKvCIR07NKwPvV7u', 1694251783, 36000, 144000, 15, 'default',
        'root', 1, 0, 0, '', '', '', 0, 0, 0, '', '', 0, '', '', '', '', '', '', '', '', '', '', '', 'null');
INSERT INTO `mcenter_token` (`id`, `platform`, `access_token`, `refresh_token`, `issue_at`, `access_expired_at`,
                             `refresh_expired_at`, `user_type`, `domain`, `username`, `user_id`, `grant_type`,
                             `token_type`, `namespace`, `scope`, `description`, `is_block`, `block_type`, `block_at`,
                             `block_reason`, `remote_ip`, `city_id`, `country`, `region`, `province`, `city`, `isp`,
                             `os`, `user_agent_platform`, `engine_name`, `engine_version`, `browser_name`,
                             `browser_version`, `meta`)
VALUES (3, 0, 'lge5riaHhsuSpbcZFA5ZQyBm', 'iYXsK7OxHIIP9spLFwvx1mh0KkSQe02G', 1694251959, 36000, 144000, 0, 'default',
        'user', 2, 0, 0, '', '', '', 0, 0, 0, '', '', 0, '', '', '', '', '', '', '', '', '', '', '', 'null');
COMMIT;
...
(
    ...
    `real_name` varchar(255)          DEFAULT '未命名' COMMENT '用户真实姓名',
...
-- ----------------------------
BEGIN;
INSERT INTO `mcenter_user` (`id`, `create_at`, `create_by`, `update_at`, `update_by`, `provider`, `type`, `domain`,
                            `username`, `password`, `nick_name`, `remark`, `gender`, `phone`, `email`, `avatar`,
                            `language`, `address`, `city`, `status`, `open_id`, `union_id`, `user_id`)
VALUES (1, 1694249969, '', 0, '', 0, 15, 'default', 'root',
        '$2a$10$DovX/19RZG2.78q1FXtIduA39FrraRLGiTAL/DJoovbx3wKtV7BJS', '', '', 0, '', '', '', '', '', '', 0, 0, 0, 0);
INSERT INTO `mcenter_user` (`id`, `create_at`, `create_by`, `update_at`, `update_by`, `provider`, `type`, `domain`,
                            `username`, `password`, `nick_name`, `remark`, `gender`, `phone`, `email`, `avatar`,
                            `language`, `address`, `city`, `status`, `open_id`, `union_id`, `user_id`)
VALUES (2, 1694250008, '', 0, '', 0, 0, 'default', 'user',
        '$2a$10$Yco2nVraiJpSgMLF0iLDyuI9EOvfO0pcDFtDKUsJddvE/Jy4Ik51i', '', '', 0, '', '', '', '', '', '', 0, 0, 0, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `mcenter_user_role` (`id`, `user_id`, `role_id`)
VALUES (1, 2, 1);
COMMIT;
