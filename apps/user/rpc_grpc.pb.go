...
const (
	RPC_QueryUser_FullMethodName    = "/user.RPC/QueryUser"
	RPC_DescribeUser_FullMethodName = "/user.RPC/DescribeUser"
	RPC_GetUserRoles_FullMethodName = "/user.RPC/GetUserRoles"
)
...
type RPCClient interface {
	...
	// 查询用户所拥有的角色
	GetUserRoles(ctx context.Context, in *GetUserRoleRequest, opts ...grpc.CallOption) (*GetUserRoleResponse, error)
}
...
func (c *rPCClient) DescribeUser(ctx context.Context, in *DescribeUserRequest, opts ...grpc.CallOption) (*DescribeUserResponse, error) {
...
func (c *rPCClient) GetUserRoles(ctx context.Context, in *GetUserRoleRequest, opts ...grpc.CallOption) (*GetUserRoleResponse, error) {
	out := new(GetUserRoleResponse)
	err := c.cc.Invoke(ctx, RPC_GetUserRoles_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RPCServer interface {
	...
	// 查询用户所拥有的角色
	GetUserRoles(context.Context, *GetUserRoleRequest) (*GetUserRoleResponse, error)
...
func (UnimplementedRPCServer) DescribeUser(context.Context, *DescribeUserRequest) (*DescribeUserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DescribeUser not implemented")
}
func (UnimplementedRPCServer) GetUserRoles(context.Context, *GetUserRoleRequest) (*GetUserRoleResponse, error) {
...
func _RPC_GetUserRoles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserRoleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RPCServer).GetUserRoles(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RPC_GetUserRoles_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RPCServer).GetUserRoles(ctx, req.(*GetUserRoleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RPC_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RPC_GetUserRoles_Handler,
		},
	},
